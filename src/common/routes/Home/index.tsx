          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
              ...
              <div className={classes.page}>
                ...
                <p>
                  We use renderToString on the server side to generate the DOM and make it download to your browser like
                  PHP or JAVA App does naturally, then we make a React hydratation when the client has been downloaded
                  via the <b>bundle.js</b> files in the {`<script src="bundle.js">`} DOM.
                </p>
                <p>
                  This frontend architecture is home made, and is as efficient as possible, which means the less code
                  the better, and also the less files the better. React SSR is very complicated to understand, I have
                  been installing this for big companies, just enjoy.
                </p>
